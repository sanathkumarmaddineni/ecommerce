...
<head>
	<title> Online store Groups </title>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Store">Store</a></h1>
				<div id="top-nav">
					<ul>
...
?>
 ...
 <div class="clear"></div>
	...
	$results = $mysqli->query("SELECT * FROM product where Warehouse_ID=9 ORDER BY Product_ID ASC");
    if ($results) { 
				...
				<div class="shell">
					<div class="box post-box">
						...
						<div class="box-entry">
							...
							<p>You can be confident when you're shopping online with Us. </p>
							<div class="cl">&nbsp;</div>
						</div>
					</div>
