...
<head>
	<title> Online store Group </title>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Suncart">store</a></h1>
				<div id="top-nav">
					<ul>
 ...
 <div class="clear"></div>
  ...
  <!-- Begin Navigation -->
					...
					<li>
					   ...
					   <li><a href="products.php"> Products</a></li>
						...
						<div class="dd">
							<ul>
								<li>
									 <a href="warehouse_1.php"> Food Staff</a>
									
								</li>
								
								<li>
									 <a href="warehouse_2.php"> Beverages</a>
									
								</li>
								
								<li>
									<a href="warehouse_3.php"> House Staff</a>
			...
			<div id="content">
				<div class="post">
					...
					<img src="images/logo.png" alt="Post Image" height="160" width="260"/>
					 Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us,
    ...
    ?>
			...
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						<h2>About Store</h2>
						<div class="box-entry">
							<img src="" alt="Store" width="160" height="80"/>
							<p> Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us,
				...
				<div class="shell">
					<div class="carts">
						<ul>
							...
							<li><a href="#" title="store"><img src="" alt="store" /></a></li>
				
						</ul>
					</div>	<p>&copy; store.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To store Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
		...
		<div class="shout_box">
      <div class="header"> live Discussion of store <div class="close_btn">&nbsp;</div></div>
